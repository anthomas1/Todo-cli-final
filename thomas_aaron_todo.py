...
def main():
    ...
    parser.add_argument("--list-name", help="Name a custom TODO list file", default="TODO.json")
    ...
    update_parser = subparsers.add_parser("update", help="The update an existing TODO item")
